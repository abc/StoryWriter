...
namespace Storyteller.Service
{
    public static class RoomService
    {
        ...
        public static void RegisterFragment(Room room, Writer writer, string fragment)
        {
            ...
            {
                room.FrameFragments.Add(new StoryFragment { Author = writer, Text = fragment, Identifier = Guid.NewGuid().ToString() });
            }
        }

        public static void RegisterVote(Room room, Writer writer, string fragmentId)
        {
            room.FragmentVotes[writer.Identifier] = fragmentId;
        }
        ...
        public static Dictionary<string, int> VotesToTotals(Dictionary<string, string> votes)
        {
