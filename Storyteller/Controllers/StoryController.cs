...
namespace Storyteller.Controllers
{
    public class StoryController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var room = SessionService.GetRoom(HttpContext.Session.GetString(SessionVariables.RoomCode));
        ...
        public ActionResult StoryText(string Id)
        {
            ...
            if (room == null)
            {
                SessionService.AddMessage(HttpContext.Session, "A room with that code could not be found, please check the code and try again.");
                return null;
            }
        ...
        public ActionResult Room(string Id = "")
        {
            ...
            HttpContext.Session.SetString(SessionVariables.RoomCode, room.Code);
